...
const BookmarkCheck = createLucideIcon("bookmark-check", __iconNode$l);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const BookmarkX = createLucideIcon("bookmark-x", __iconNode$k);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
function BottomNav({ current, onChange }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 z-50 safe-area-pb", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-[430px] mx-auto flex", children: tabs.map(({ id, label, Icon: Icon2 }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "button",
    {
      type: "button",
      "data-ocid": `nav.${id}_link`,
      onClick: () => onChange(id),
      className: `flex-1 flex flex-col items-center py-2 pt-3 transition-colors ${current === id ? "text-teal-600" : "text-gray-400"}`,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { size: 22 }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] mt-0.5 font-medium", children: label })
      ]
    },
    id
  )) }) });
...
const questionBank = [
  ...
  },
  {
    ...
    correctIndex: 1n,
    explanation: "Assistants support veterinarians but do not diagnose or prescribe."
  },
  {
    id: 5n,
    category: "safety",
  ...
  },
  {
    ...
    correctIndex: 2n,
    explanation: "Hemostats are used to clamp blood vessels and control bleeding."
  },
  {
    id: 8n,
    category: "sanitation",
  ...
  },
  {
    ...
    correctIndex: 1n,
    explanation: "Patient intake gathers essential information before the veterinarian sees the patient."
  },
  {
    id: 19n,
    category: "safety",
    ...
    correctIndex: 1n,
    explanation: "Flushing the area with water immediately reduces chemical exposure risk."
  },
  {
    id: 20n,
    category: "sanitation",
    ...
    correctIndex: 1n,
    explanation: "Removing organic matter first ensures disinfectants work effectively."
  },
  {
    id: 21n,
    category: "restraint",
    ...
    correctIndex: 1n,
    explanation: "Safety for both staff and the animal is the top priority with aggressive patients."
  },
  {
    id: 22n,
    category: "vital_signs",
  ...
  },
  {
    ...
    correctIndex: 2n,
    explanation: "Diagnosis is restricted to licensed veterinarians, not assistants."
  },
  {
    id: 27n,
    category: "law",
    ...
    correctIndex: 1n,
    explanation: "Only licensed veterinarians can legally prescribe medications."
  },
  {
    id: 28n,
    category: "ethics",
    ...
    correctIndex: 1n,
    explanation: "Referring diagnosis questions to the veterinarian is both ethical and legally required."
  },
  {
    id: 29n,
    category: "safety",
    ...
    correctIndex: 1n,
    explanation: "Frequent handwashing prevents cross-contamination between patients."
  },
  {
    id: 30n,
    category: "communication",
    ...
    correctIndex: 1n,
    explanation: "Clear, simple communication helps owners understand and follow care plans."
  }
];
const flashcardDeck = [
  {
  ...
  },
  {
    ...
    category: "safety",
    term: "OSHA",
    definition: "Occupational Safety and Health Administration – ensures workplace safety",
  ...
  },
  {
    ...
    definition: "Law that regulates veterinary medicine and who can perform procedures",
  ...
  },
  {
    ...
    definition: "Supports veterinarians with patient care, cleaning, and basic tasks",
  ...
  },
  {
    ...
    category: "sanitation",
    term: "Autoclave",
    definition: "Device used to sterilize instruments using high-pressure steam",
    usage: "Instrument sterilization"
  }
];
function isDatasetsReady() {
...
function QuestionCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-4", children: [
    questionNumber !== void 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-sm text-gray-500", children: [
        "Question ",
        questionNumber,
        totalQuestions ? ` of ${totalQuestions}` : ""
      ] }),
      onBookmark && /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          type: "button",
          ...
          children: isBookmarked ? /* @__PURE__ */ jsxRuntimeExports.jsx(BookmarkCheck, { size: 20, className: "text-teal-600" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Bookmark, { size: 20 })
        }
      )
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white rounded-2xl p-5 shadow-sm border border-gray-100", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-base font-semibold text-gray-800 leading-snug", children: question.text }),
      question.category && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-block mt-2 text-xs bg-teal-50 text-teal-700 px-2 py-0.5 rounded-full", children: question.category.replace(/_/g, " ") })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col gap-2", children: question.options.map((opt, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        type: "button",
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
            {
              className: `flex-shrink-0 w-7 h-7 rounded-full border-2 flex items-center justify-center text-xs font-bold ${!answered ? "border-gray-300 text-gray-500" : i === correct ? "border-green-500 bg-green-500 text-white" : i === selectedIndex ? "border-red-400 bg-red-400 text-white" : "border-gray-200 text-gray-400"}`,
              children: LETTERS[i]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-medium leading-snug", children: opt })
        ]
      },
      i
    )) }),
    answered && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        className: `rounded-2xl p-4 ${selectedIndex === correct ? "bg-green-50 border border-green-200" : "bg-orange-50 border border-orange-200"}`,
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "p",
            {
              className: `text-sm font-semibold mb-1 ${selectedIndex === correct ? "text-green-700" : "text-orange-700"}`,
              children: selectedIndex === correct ? "✓ Correct!" : "✗ Incorrect"
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-gray-700", children: question.explanation })
        ]
      }
    ),
    answered && showNext && onNext && /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        type: "button",
...
function BookmarksPage({
  ...
  const [quizMode, setQuizMode] = reactExports.useState(false);
  const [idx, setIdx] = reactExports.useState(0);
  const [selected, setSelected] = reactExports.useState(null);
  const bookmarkedQs = questions2.filter(
    (q) => bookmarks.includes(Number(q.id))
  );
  ...
  if (bookmarkedQs.length === 0) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-4", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl font-extrabold text-gray-800", children: "Bookmarks" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-4 py-12", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(BookmarkX, { size: 48, className: "text-gray-300" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-500 text-center", children: "No bookmarks yet. Tap the bookmark icon on any question to save it here." })
      ] })
    ] });
  }
  if (quizMode) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-3", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        ...
        children: "Practice All Bookmarks"
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col gap-2", children: bookmarkedQs.map((q) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        className: "bg-white rounded-2xl p-4 shadow-sm border border-gray-100 flex items-start gap-3",
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium text-gray-700 line-clamp-2", children: q.text }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-block mt-1 text-xs bg-teal-50 text-teal-600 px-2 py-0.5 rounded-full", children: q.category.replace(/_/g, " ") })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(BookmarkX, { size: 18 })
            }
          )
        ]
      },
...
function buildQuiz(pool, desiredLength) {
...
function DailyChallengePage({
  ...
  const [daily, setDaily] = useLocalStorage("vet_daily_challenge", null);
  const [streak, setStreak] = useLocalStorage("vet_streak", { lastDate: "", count: 0 });
  const [quizQuestions, setQuizQuestions] = reactExports.useState([]);
  const [idx, setIdx] = reactExports.useState(0);
  const [selected, setSelected] = reactExports.useState(null);
  const [score, setScore] = reactExports.useState(0);
  const [done, setDone] = reactExports.useState(false);
  const alreadyDone = (daily == null ? void 0 : daily.date) === today() && daily.completed;
  reactExports.useEffect(() => {
    if (!alreadyDone) {
      setQuizQuestions(buildQuiz(questions2, 10));
    }
  }, [questions2, alreadyDone]);
  ...
  if (alreadyDone || done) {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-5", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-4 py-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Trophy, { size: 48, className: "text-yellow-400" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl font-extrabold text-gray-800", children: "Daily Challenge" }),
        !done && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-500 text-sm", children: "You already completed today's challenge!" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-6xl font-extrabold text-teal-600", children: [
          pct,
          "%"
        ] }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-500 text-sm", children: "Come back tomorrow for a new challenge!" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "button",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 h-2 bg-gray-100 rounded-full", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-bold text-gray-700", children: "Daily Challenge" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      QuestionCard,
      {
        ...
        onNext: handleNext,
        nextLabel: idx + 1 >= quizQuestions.length ? "Finish Challenge" : "Next Question"
      }
    )
  ] });
}
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-teal-600 font-semibold uppercase tracking-widest mb-4", children: "Term" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-2xl font-bold text-gray-800 text-center", children: card.term }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "mt-4 text-xs text-gray-400", children: "Tap to reveal" })
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-teal-100 font-semibold uppercase tracking-widest mb-4", children: "Definition" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-base font-semibold text-white text-center mb-3", children: card.definition }),
                  card.usage && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-teal-100 text-center italic", children: card.usage }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "mt-4 text-xs text-teal-200", children: "Tap to flip back" })
                ]
              }
            )
          ]
...
function LoadingScreen() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center justify-center h-full min-h-[300px] gap-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 border-4 border-teal-600 border-t-transparent rounded-full animate-spin" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-500 text-sm", children: "Loading study content..." })
  ] });
}
...
function FlashcardsPage({
  ...
  const [categoryKey, setCategoryKey] = reactExports.useState(null);
  const [deck, setDeck] = reactExports.useState([]);
  const [idx, setIdx] = reactExports.useState(0);
  const [shownIDs, setShownIDs] = reactExports.useState(/* @__PURE__ */ new Set());
  const [debugOn, setDebugOn] = reactExports.useState(false);
  const startDeck = (key) => {
    var _a2;
    const cards = key === "all" ? flashcards2 : flashcards2.filter((f) => f.category === key);
    const shuffled = shuffle(cards);
    setDeck(shuffled);
    setIdx(0);
    setShownIDs(new Set([(_a2 = shuffled[0]) == null ? void 0 : _a2.id].filter(Boolean)));
    setCategoryKey(key);
  };
  const handleShuffle = () => {
    setDeck((d) => shuffle(d));
    setIdx(0);
    setShownIDs(/* @__PURE__ */ new Set());
  };
  const handleNext = () => {
    var _a2;
    const nextIdx = idx + 1;
    if (nextIdx >= deck.length) {
      ...
      setDeck(reshuffled);
      setIdx(0);
      setShownIDs(new Set([(_a2 = reshuffled[0]) == null ? void 0 : _a2.id].filter(Boolean)));
    } else {
      setIdx(nextIdx);
      setShownIDs((prev) => {
  ...
  if (categoryKey === null) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "paw-bg flex flex-col gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl font-extrabold text-gray-800", children: "Flashcards" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-gray-500", children: "Choose a category" }),
      CATEGORIES$2.map((cat) => {
        const count = cat.key === "all" ? flashcards2.length : flashcards2.filter((f) => f.category === cat.key).length;
        return /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-gray-700", children: cat.label }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs bg-purple-50 text-purple-600 px-2 py-1 rounded-full font-semibold", children: [
                count,
                " cards"
              ] })
            ]
  ...
  if (deck.length === 0) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "paw-bg flex flex-col items-center gap-4 py-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-500", children: "No flashcards in this category yet." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          type: "button",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "paw-bg flex flex-col gap-5", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Shuffle, { size: 14 }),
            " Shuffle"
          ]
        }
      )
    ...
    debugOn && currentCard && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-xs bg-yellow-50 border border-yellow-300 rounded-xl px-3 py-1.5 text-yellow-800 font-mono", children: [
      "🔍 DEBUG — Card ID: ",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-1 justify-center flex-wrap", children: deck.slice(0, Math.min(deck.length, 20)).map((_, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        className: `w-2 h-2 rounded-full transition-colors ${i === idx ? "bg-teal-600" : "bg-gray-200"}`
      },
      i
    )) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(FlashCard, { card: currentCard }, `${idx}-${currentCard == null ? void 0 : currentCard.id}`),
...
function HomePage({
  ...
  const searchResults = search.trim().length > 1 ? [
    ...questions2.filter((q) => q.text.toLowerCase().includes(search.toLowerCase())).slice(0, 5).map((q) => ({
      type: "Question",
      text: q.text,
      category: q.category
    })),
    ...flashcards2.filter((f) => f.term.toLowerCase().includes(search.toLowerCase())).slice(0, 5).map((f) => ({
      type: "Flashcard",
      text: f.term,
      category: f.category
    }))
  ] : [];
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "paw-bg flex flex-col gap-5 pb-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "img",
        {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-lg font-extrabold text-gray-800 leading-tight", children: "Vet Assistant" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-teal-600 font-semibold", children: "Exam Prep" })
      ] }),
      streak > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "ml-auto flex items-center gap-1 bg-orange-50 text-orange-500 px-3 py-1.5 rounded-full", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Flame, { size: 14 }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-bold", children: streak })
      ] })
    ] }),
    ...
    searchResults.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden", children: searchResults.map((r2, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
            {
              className: `text-xs px-2 py-0.5 rounded-full font-medium ${r2.type === "Question" ? "bg-blue-50 text-blue-600" : "bg-purple-50 text-purple-600"}`,
              children: r2.type
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-gray-700 flex-1 truncate", children: r2.text })
        ]
      },
      i
    )) }),
    search.trim().length > 1 && searchResults.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-gray-400 text-center", children: "No results found" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        type: "button",
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute right-4 top-1/2 -translate-y-1/2 text-white/20", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Trophy, { size: 60 }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Trophy, { size: 16, className: "text-yellow-300" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-semibold text-teal-100 uppercase tracking-wider", children: "Daily Challenge" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white font-bold text-lg", children: dailyCompleted ? "Challenge Complete! ✓" : "10 Questions Today" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-teal-100 text-sm mt-1", children: dailyCompleted ? "Come back tomorrow for a new challenge" : "Test your knowledge across all topics" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1 mt-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white text-sm font-semibold", children: dailyCompleted ? "See results" : "Start now" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronRight, { size: 16, className: "text-white" })
          ] })
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 bg-yellow-50 rounded-2xl flex items-center justify-center flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Zap, { size: 22, className: "text-yellow-500" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-bold text-gray-800", children: "Quick Study Mode" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-gray-500", children: "5-minute timed review session" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronRight, { size: 18, className: "text-gray-300 ml-auto" })
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-sm font-bold text-gray-500 uppercase tracking-wider mb-3", children: "Recommended Study Flow" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col gap-2", children: STUDY_STEPS.map((step, idx) => {
        const done = step.completedKey ? localStorage.getItem(step.completedKey) === "true" : false;
        const ocid = `home.study_flow.step.${idx + 1}`;
        return /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            type: "button",
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-10 rounded-full bg-teal-600 text-white flex items-center justify-center flex-shrink-0 font-bold text-sm", children: idx + 1 }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-bold text-gray-800 text-sm truncate", children: step.label }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-gray-500 mt-0.5", children: step.description })
              ] }),
...
function ScoreScreen({
  ...
  const colorClass = pct >= 70 ? "text-teal-600" : pct >= 50 ? "text-yellow-500" : "text-red-500";
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-6 py-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `text-7xl font-extrabold ${colorClass}`, children: [
      pct,
      "%"
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-gray-600 text-lg font-medium", children: [
      score,
      " / ",
      total,
      " correct"
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-500 text-sm text-center", children: messages[stars] }),
...
const prepVideoQuestions = [
  {
    ...
    correctIndex: 1,
    explanation: "Veterinary assistants support the veterinarian by restraining animals, performing basic care tasks, cleaning equipment, and keeping the clinic running smoothly — but they do not diagnose or prescribe.",
  ...
  },
  {
    ...
    correctIndex: 2,
    explanation: "For a calm dog, the standard lateral or standing restraint — one arm under the neck cradling the head, and the other arm around the body — provides safe, gentle control for routine exams.",
  ...
  },
  {
    ...
    correctIndex: 1,
    explanation: "Proper workflow begins with client greeting and chart verification, followed by obtaining the patient's weight and preliminary vitals. The vet assistant then prepares the exam room so the veterinarian can focus entirely on the patient.",
  ...
  },
  {
    ...
    correctIndex: 2,
    explanation: "Gloves are standard PPE for handling all patients. A gown or clinic coat protects clothing, and a mask is added when there is risk of respiratory transmission. PPE choice is based on the risk level of the situation.",
  ...
  },
  {
    ...
    correctIndex: 2,
    explanation: "Proper instrument reprocessing involves removing visible debris by scrubbing, using an ultrasonic cleaner to dislodge microscopic particles, and then autoclaving (steam sterilization) to achieve sterility before the instruments are used again.",
    category: "Sanitation"
  }
];
...
function PrepVideoPage({ onBack }) {
  const iframeRef = reactExports.useRef(null);
  const [isCompleted, setIsCompleted] = reactExports.useState(
    () => localStorage.getItem(COMPLETED_KEY) === "true"
  );
  const [videoEnded, setVideoEnded] = reactExports.useState(false);
  const [quizMode, setQuizMode] = reactExports.useState(false);
  const [quizIdx, setQuizIdx] = reactExports.useState(0);
  const [quizSelected, setQuizSelected] = reactExports.useState(null);
  ...
  reactExports.useEffect(() => {
    const handler = (event) => {
      ...
      try {
        ...
        if (data.event === "infoDelivery" && data.info && data.info.currentTime != null && data.info.duration != null && data.info.duration > 0) {
  ...
  if (quizMode) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-4 pb-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          type: "button",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-bold text-gray-800 text-lg", children: "Post-Video Quiz" }),
      ...
      quizDone ? /* @__PURE__ */ jsxRuntimeExports.jsx(
        ScoreScreen,
        {
          score: quizScore,
        ...
        QuestionCard,
        {
          ...
          onNext: handleNext,
          showNext: true,
          nextLabel: quizIdx + 1 === prepVideoQuestions.length ? "See Results" : "Next Question"
        }
      )
    ] });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-5 pb-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-xl font-extrabold text-gray-800", children: "Watch Before Testing" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-gray-500 mt-1", children: "Watch the training demonstration to prepare for quizzes and the certification exam." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-2xl overflow-hidden shadow-md bg-black aspect-video", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      "iframe",
      {
        ref: iframeRef,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white rounded-2xl p-5 border border-gray-100 shadow-sm", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 rounded-xl bg-teal-50 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Play, { size: 14, className: "text-teal-600" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-bold text-gray-800", children: "Key Skills From This Video" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "flex flex-col gap-2", children: KEY_SKILLS.map((skill) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "li",
        {
          className: "flex items-start gap-2.5 text-sm text-gray-700",
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-5 h-5 rounded-full bg-teal-600 text-white text-xs flex items-center justify-center flex-shrink-0 mt-0.5", children: KEY_SKILLS.indexOf(skill) + 1 }),
            skill
          ]
        },
        skill
...
function ProgressPage() {
  const [scores] = useLocalStorage("vet_scores", {});
  const [streak] = useLocalStorage(
    "vet_streak",
    { lastDate: "", count: 0 }
  );
  const [watched] = useLocalStorage("vet_watched_videos", []);
  const [bookmarks] = useLocalStorage("vet_bookmarks", []);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-5", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl font-extrabold text-gray-800", children: "Progress" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-teal-50 rounded-2xl p-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-teal-600 font-semibold mb-1", children: "Overall Accuracy" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-3xl font-extrabold text-teal-700", children: [
          overallPct,
          "%"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-teal-600 mt-1", children: [
          totalCorrect,
          "/",
          totalAnswered,
          " correct"
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-orange-50 rounded-2xl p-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1 mb-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Flame, { size: 14, className: "text-orange-500" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-orange-600 font-semibold", children: "Study Streak" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-3xl font-extrabold text-orange-500", children: streak.count }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-orange-500 mt-1", children: "days in a row" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-red-50 rounded-2xl p-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1 mb-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(CirclePlay, { size: 14, className: "text-red-500" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-red-600 font-semibold", children: "Videos Watched" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-3xl font-extrabold text-red-500", children: [
          watched.length,
          "/6"
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-yellow-50 rounded-2xl p-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1 mb-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(BookmarkCheck, { size: 14, className: "text-yellow-600" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-yellow-700 font-semibold", children: "Bookmarked" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-3xl font-extrabold text-yellow-600", children: bookmarks.length }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-yellow-600 mt-1", children: "questions saved" })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white rounded-2xl p-4 shadow-sm border border-gray-100", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(ChartNoAxesColumn, { size: 16, className: "text-teal-600" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-bold text-gray-800", children: "By Category" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col gap-3", children: CATEGORIES$1.map((cat) => {
        const data = scores[cat.key];
        const pct = data && data.total > 0 ? Math.round(data.correct / data.total * 100) : 0;
        const answered = (data == null ? void 0 : data.total) || 0;
        return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-medium text-gray-600", children: cat.label }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-gray-400", children: answered > 0 ? `${pct}% (${answered} Qs)` : "Not started" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-2.5 bg-gray-100 rounded-full overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              className: `h-full rounded-full transition-all ${pct >= 80 ? "bg-green-500" : pct >= 60 ? "bg-yellow-400" : pct > 0 ? "bg-red-400" : "bg-gray-200"}`,
              style: { width: `${pct}%` }
            }
          ) })
        ] }, cat.key);
    ...
    ) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-red-50 rounded-2xl p-4 flex flex-col gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold text-red-700", children: "Are you sure? This will clear all progress." }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
...
function QuickStudyPage({
  questions: questions2,
  onBack
}) {
  const DURATION = 5 * 60;
  const [quizQuestions] = reactExports.useState(() => buildQuiz(questions2, 10));
  const [idx, setIdx] = reactExports.useState(0);
  const [selected, setSelected] = reactExports.useState(null);
  const [score, setScore] = reactExports.useState(0);
  const [done, setDone] = reactExports.useState(false);
  ...
  const timerColor = timeLeft < 60 ? "text-red-500" : timeLeft < 120 ? "text-yellow-500" : "text-teal-600";
  if (done || quizQuestions.length === 0) {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-5", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-4 py-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Zap, { size: 48, className: "text-yellow-400" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl font-extrabold text-gray-800", children: "Quick Study Complete!" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-6xl font-extrabold text-teal-600", children: [
          pct,
          "%"
        ] }),
        ...
        timeLeft > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-gray-400", children: [
          mins,
          ":",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `flex items-center gap-1.5 font-bold ${timerColor}`, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Zap, { size: 14, className: "text-yellow-500" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-bold text-gray-700", children: "Quick Study" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 h-2 bg-gray-100 rounded-full ml-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          className: "h-full bg-yellow-400 rounded-full transition-all",
          style: { width: `${idx / quizQuestions.length * 100}%` }
...
function QuizPage({ questions: questions2, loading }) {
  const [mode, setMode] = reactExports.useState("select");
  const [categoryKey, setCategoryKey] = reactExports.useState("all");
  const [quizQuestions, setQuizQuestions] = reactExports.useState([]);
  const [currentIdx, setCurrentIdx] = reactExports.useState(0);
  const [selectedIndex, setSelectedIndex] = reactExports.useState(null);
  const [score, setScore] = reactExports.useState(0);
  const [usedQuestionIDs, setUsedQuestionIDs] = reactExports.useState(
    /* @__PURE__ */ new Set()
  );
  const [debugOn, setDebugOn] = reactExports.useState(false);
  const [bookmarks, setBookmarks] = useLocalStorage(
  ...
  const [_scores, setScores] = useLocalStorage("vet_scores", {});
  const startQuiz = reactExports.useCallback(
    (catKey) => {
      let pool = catKey === "all" ? questions2 : questions2.filter((q) => q.category === catKey);
  ...
  const handleNext = () => {
    ...
    if (currentIdx + 1 >= quizQuestions.length) {
      const cat = ((_a2 = quizQuestions[0]) == null ? void 0 : _a2.category) || categoryKey;
      setScores((prev) => {
  ...
  const toggleBookmark = () => {
    setBookmarks(
      (prev) => prev.includes(qId) ? prev.filter((id) => id !== qId) : [...prev, qId]
    );
  };
  if (loading) return /* @__PURE__ */ jsxRuntimeExports.jsx(LoadingScreen, {});
  if (mode === "select") {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "paw-bg flex flex-col gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl font-extrabold text-gray-800", children: "Practice Quiz" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-gray-500", children: "Choose a category to start" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col gap-2", children: CATEGORIES.map((cat) => {
        const count = cat.key === "all" ? questions2.length : questions2.filter((q) => q.category === cat.key).length;
        return /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            type: "button",
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-gray-700", children: cat.label }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs bg-teal-50 text-teal-600 px-2 py-1 rounded-full font-semibold", children: [
                count,
                " Qs"
              ] })
            ]
  ...
  if (mode === "score") {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "paw-bg flex flex-col gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          type: "button",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "paw-bg flex flex-col gap-4", children: [
    ...
    debugOn && currentQ && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-xs bg-yellow-50 border border-yellow-300 rounded-xl px-3 py-1.5 text-yellow-800 font-mono", children: [
      "🔍 DEBUG — Question ID: ",
      String(currentQ.id),
      " | Unique in session:",
      " ",
    ...
    currentQ && /* @__PURE__ */ jsxRuntimeExports.jsx(
      QuestionCard,
      {
        ...
        nextLabel: currentIdx + 1 >= quizQuestions.length ? "See Results" : "Next Question"
      }
    )
  ] });
}
const letters$1 = ["A", "B", "C", "D"];
function ScenariosPage({
  ...
  if (!selected) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl font-extrabold text-gray-800", children: "Clinic Scenarios" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-gray-500", children: "Practice real-world veterinary situations" }),
      scenarios2.map((s, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          type: "button",
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-10 bg-green-50 rounded-xl flex items-center justify-center flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Stethoscope, { size: 18, className: "text-green-600" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold text-gray-700 line-clamp-2", children: s.situation }),
              s.category && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-block mt-1 text-xs bg-green-50 text-green-700 px-2 py-0.5 rounded-full", children: s.category })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              ChevronRight,
              {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-4", children: [
    ...
    selected.category && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "self-start text-xs bg-green-50 text-green-700 px-3 py-1 rounded-full font-semibold", children: selected.category }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-green-50 rounded-2xl p-5 border border-green-100", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Stethoscope, { size: 16, className: "text-green-600" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-bold text-green-700 uppercase tracking-wider", children: "Clinical Scenario" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-800 text-sm leading-relaxed", children: selected.situation })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-white rounded-2xl p-4 shadow-sm border border-gray-100", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-gray-800", children: selected.question }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col gap-2", children: selected.choices.map((opt, i) => {
      let style2 = "bg-white border-gray-200 hover:border-green-400";
      if (choice !== null) {
        if (i === correct)
          style2 = "bg-green-50 border-green-500 text-green-800";
        else if (i === choice)
          style2 = "bg-red-50 border-red-400 text-red-800";
        else style2 = "bg-white border-gray-200 opacity-50";
      }
      return /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          ...
          className: `w-full text-left p-4 rounded-2xl border-2 transition-all flex items-start gap-3 ${style2}`,
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "flex-shrink-0 w-7 h-7 rounded-full border-2 border-gray-300 flex items-center justify-center text-xs font-bold", children: letters$1[i] }),
    ...
    choice !== null && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        className: `rounded-2xl p-4 ${choice === correct ? "bg-green-50 border border-green-200" : "bg-orange-50 border border-orange-200"}`,
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "p",
            {
              className: `text-sm font-semibold mb-1 ${choice === correct ? "text-green-700" : "text-orange-700"}`,
              children: choice === correct ? "✓ Correct!" : "✗ Incorrect"
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-gray-700", children: selected.explanation })
        ]
      }
    ),
    choice !== null && /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        type: "button",
        onClick: () => setSelected(null),
...
const videoData = [
  {
    ...
    duration: "8 min",
    summary: "Learn to accurately measure and record vital signs in dogs and cats, including temperature, pulse, respiration, and mucous membrane color.",
    keyTakeaways: [
  ...
  },
  {
    ...
    duration: "10 min",
    summary: "Identify and understand the purpose of common veterinary surgical and diagnostic instruments used in everyday clinical practice.",
    keyTakeaways: [
  ...
  },
  {
    ...
    duration: "9 min",
    summary: "Master safe handling and restraint techniques for dogs and cats to protect both the animal and clinical staff during examinations.",
    keyTakeaways: [
  ...
  },
  {
    ...
    duration: "7 min",
    summary: "Understand the correct procedures for cleaning and disinfecting veterinary clinic surfaces, instruments, and cages to prevent disease transmission.",
    keyTakeaways: [
  ...
  },
  {
    ...
    duration: "11 min",
    summary: "Learn how to apply primary, secondary, and tertiary bandage layers correctly to protect wounds and support healing in veterinary patients.",
    keyTakeaways: [
  ...
  },
  {
    ...
    summary: "Learn proper methods for safely restraining dogs during veterinary exams. Good restraint keeps both the patient and staff safe.",
    keyTakeaways: [
  ...
  },
  {
    ...
    summary: "Master the towel wrap technique to safely restrain cats for examination without causing undue stress.",
    keyTakeaways: [
  ...
  },
  {
    ...
    summary: "Step-by-step guide for accurately measuring a dog's rectal temperature and recording your findings.",
    keyTakeaways: [
  ...
  },
  {
    ...
    summary: "Learn to accurately assess heart rate and identify normal versus abnormal heart sounds in veterinary patients.",
    keyTakeaways: [
  ...
  },
  {
    ...
    summary: "Identify and describe the use of common veterinary surgical instruments used in routine procedures.",
    keyTakeaways: [
  ...
  },
  {
    ...
    summary: "Proper sanitation and disinfection protocols to maintain a safe and hygienic veterinary clinic environment.",
    keyTakeaways: [
  ...
  },
  {
    ...
    duration: "15 min",
    summary: "A comprehensive Certified Veterinary Assistant exam prep video covering key topics including anatomy, pharmacology, patient care, safety, and clinical procedures to help you pass the CVA certification exam.",
    keyTakeaways: [
...
const videoQuizData = {
  GZV6X9l9l8E: [
    ...
    },
    {
      ...
      correctIndex: 2,
      explanation: "The femoral artery inside the thigh is standard for pulse measurement in dogs."
    },
    {
    ...
    {
      question: "What does a capillary refill time greater than 2 seconds indicate?",
      options: [
        "Normal circulation",
      ...
      correctIndex: 1,
      explanation: "CRT > 2 seconds can indicate shock, dehydration, or cardiovascular compromise."
    },
    {
      ...
      correctIndex: 0,
      explanation: "TPR = Temperature, Pulse, Respiration — the three core vital signs."
    }
  ],
  Gg2rRkR8X9E: [
    {
      ...
      correctIndex: 1,
      explanation: "Hemostats clamp blood vessels to control bleeding during surgery."
    },
    {
      ...
      correctIndex: 1,
      explanation: "Metzenbaum scissors are for delicate tissue; Mayo scissors handle heavier tissue."
    },
    {
      ...
      correctIndex: 1,
      explanation: "Instruments are always passed handle-first for safety and efficiency."
    },
    {
      ...
      correctIndex: 1,
      explanation: "Thumb forceps (tissue forceps) grip tissue without a locking mechanism."
    },
    {
      ...
      correctIndex: 1,
      explanation: "Needle holders secure the suture needle so the surgeon can drive it through tissue."
    }
  ],
  Qm3VQ9Z2Zk8: [
    {
      ...
      correctIndex: 1,
      explanation: "Minimum restraint reduces animal stress and risk of injury."
    },
    {
    ...
    },
    {
      ...
      correctIndex: 1,
      explanation: "Muzzles are used when there is a risk of biting to protect staff."
    },
    {
    ...
    {
      question: "What should you avoid using as the primary restraint for cats?",
      options: [
        "Towel wrap",
        "Scruff hold",
        "Lateral recumbency",
      ...
      correctIndex: 1,
      explanation: "The scruff should not be the primary restraint—it can cause stress; towel wraps are preferred."
    }
  ],
  "3JpQK7wJY5E": [
    {
      ...
      correctIndex: 1,
      explanation: "Organic matter inactivates most disinfectants, so surfaces must be cleaned first."
    },
    {
      ...
      correctIndex: 1,
      explanation: "Disinfectants must remain wet for the labeled contact time to be fully effective."
    },
    {
      question: "Where should used needles be discarded?",
      options: ["Regular trash", "Sharps container", "Biohazard bag", "Sink"],
      correctIndex: 1,
      explanation: "Sharps containers are required for safe disposal of needles and sharp objects."
    },
    {
      ...
      correctIndex: 2,
      explanation: "Biohazard bags are for materials that have been contaminated with biological matter."
    },
    {
      ...
      correctIndex: 1,
      explanation: "Appropriate PPE protects staff from chemical exposure and splashing."
    }
  ],
  Z7zZk3z4Y0M: [
    {
    ...
    },
    {
      ...
      correctIndex: 1,
      explanation: "Bandages should be checked every 12–24 hours for signs of complications."
    },
    {
      ...
      correctIndex: 1,
      explanation: "Digit swelling or coldness below the bandage indicates impaired circulation."
    },
    {
      ...
      correctIndex: 2,
      explanation: "The outer layer holds everything in place and protects against contamination."
    },
    {
      question: "Which layer provides padding and moisture absorption in a bandage?",
      options: [
        "Primary layer",
        "Secondary layer",
        "Tertiary layer",
      ...
      correctIndex: 1,
      explanation: "The secondary (padded) layer cushions and absorbs moisture."
    }
  ],
  bnwkbz4IAY0: [
    {
      question: "Which of the following is a core topic covered on the CVA certification exam?",
      options: [
      ...
      correctIndex: 1,
      explanation: "The CVA exam covers veterinary-specific topics including pharmacology, patient care, anatomy, and clinical procedures."
    },
    {
      ...
      correctIndex: 2,
      explanation: "Antibiotics are antimicrobial drugs that kill or inhibit the growth of bacteria."
    },
    {
      question: "What does the medical prefix 'brady-' mean?",
      options: ["Fast", "Slow", "Large", "Small"],
      correctIndex: 1,
      explanation: "'Brady-' means slow; for example, bradycardia means a slow heart rate."
    },
    {
      question: "According to OSHA standards, where must sharps be disposed of?",
      options: [
        "Regular trash can",
        "Biohazard bag",
      ...
      correctIndex: 2,
      explanation: "OSHA requires sharps to be discarded in puncture-resistant, labeled sharps containers to prevent needlestick injuries."
    },
    {
      question: "Which type of question is most common on the CVA practice exam?",
      options: [
      ...
      correctIndex: 1,
      explanation: "CVA exams primarily use multiple-choice questions that test both factual knowledge and practical decision-making skills."
    }
  ]
};
const COMPLETIONS_KEY = "vet_video_completions";
function videoQuizToQuestion(vq, index2) {
  return {
    id: BigInt(9e3 + index2),
    text: vq.question,
    options: vq.options,
...
function VideosPage({ videoQuestions: videoQuestions2 }) {
  ...
  const [quizScore, setQuizScore] = reactExports.useState(0);
  const [quizDone, setQuizDone] = reactExports.useState(false);
  const [_watched, setWatched] = useLocalStorage(
    "vet_watched_videos",
    []
  );
  ...
  const localQuiz = selectedVideo ? videoQuizData[selectedVideo] ?? null : null;
  const questions2 = localQuiz ? localQuiz.map((vq, i) => videoQuizToQuestion(vq, i)) : selectedVideo ? videoQuestions2[selectedVideo] || [] : [];
  const markCompleted = reactExports.useCallback(
    (id) => {
  ...
  reactExports.useEffect(() => {
    ...
    const handler = (event) => {
      ...
      try {
        ...
        if (data.event === "infoDelivery" && ((_a2 = data.info) == null ? void 0 : _a2.currentTime) != null && ((_b2 = data.info) == null ? void 0 : _b2.duration) != null && data.info.duration > 0) {
          const progress = data.info.currentTime / data.info.duration;
          if (progress >= 0.8) {
            markCompleted(selectedVideo);
          }
  ...
  const handleSelect = (i) => {
    setQuizSelected(i);
    if (questions2[quizIdx] && i === Number(questions2[quizIdx].correctIndex)) {
      setQuizScore((s) => s + 1);
    }
  };
  const handleNext = () => {
    if (quizIdx + 1 >= questions2.length) {
      setQuizDone(true);
    } else {
      setQuizIdx((i) => i + 1);
      setQuizSelected(null);
  ...
  if (!selectedVideo) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "paw-bg flex flex-col gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl font-extrabold text-gray-800", children: "Video Learning" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-gray-500", children: "Watch and learn, then test your knowledge" }),
      videoData.map((v, i) => {
        var _a2;
        return /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            className: "bg-white rounded-2xl border border-gray-100 shadow-sm p-4 text-left flex items-start gap-4 active:scale-[0.98] transition-transform",
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-14 h-14 bg-red-50 rounded-2xl flex items-center justify-center flex-shrink-0", children: completions.includes(v.youtubeId) ? /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheckBig, { size: 24, className: "text-green-500" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(CirclePlay, { size: 24, className: "text-red-500" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-gray-800 text-sm", children: v.title }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-gray-500 mt-1 line-clamp-2", children: v.summary }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mt-2 flex-wrap", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs bg-gray-100 text-gray-500 px-2 py-0.5 rounded-full", children: v.duration }),
                  ((_a2 = videoQuizData[v.youtubeId] ?? videoQuestions2[v.youtubeId]) == null ? void 0 : _a2.length) > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs bg-blue-50 text-blue-600 px-2 py-0.5 rounded-full", children: [
                    (videoQuizData[v.youtubeId] ?? videoQuestions2[v.youtubeId]).length,
                    " ",
                    "quiz Qs"
                  ] }),
                  completions.includes(v.youtubeId) && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs bg-green-50 text-green-600 px-2 py-0.5 rounded-full", children: "Completed" })
                ] })
              ] })
            ]
          },
  ...
  if (quizMode) {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "paw-bg flex flex-col gap-4", children: [
      ...
      questions2[quizIdx] && /* @__PURE__ */ jsxRuntimeExports.jsx(
        QuestionCard,
        {
          question: questions2[quizIdx],
          selectedIndex: quizSelected,
          onSelect: handleSelect,
          onNext: handleNext,
          nextLabel: quizIdx + 1 >= questions2.length ? "See Results" : "Next"
        }
      )
    ] });
  }
  ...
  const hasQuiz = questions2.length > 0;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "paw-bg flex flex-col gap-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-lg font-extrabold text-gray-800", children: video.title }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-white rounded-2xl p-4 shadow-sm border border-gray-100", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-gray-700", children: video.summary }) }),
    video.keyTakeaways.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-teal-50 rounded-2xl p-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(BookOpen, { size: 16, className: "text-teal-600" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold text-teal-700", children: "Key Takeaways" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "flex flex-col gap-2", children: video.keyTakeaways.map((item, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "li",
        {
          className: "flex items-start gap-2 text-sm text-teal-800",
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-5 h-5 rounded-full bg-teal-600 text-white text-xs flex items-center justify-center flex-shrink-0 mt-0.5", children: i + 1 }),
            item
          ]
        },
        item
    ...
    hasQuiz && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(RotateCcw, { size: 16 }),
          isCompleted ? "Retake Quiz" : `Take Quiz (${questions2.length} questions)`
        ]
      }
    )
  ] });
...
const visualQuestions = [
  {
    ...
    question: "Which instrument is used to clamp blood vessels and control bleeding?",
    options: [
      "Scalpel",
    ...
    correctIndex: 1,
    explanation: "Hemostatic forceps (hemostats) are locking clamps used to control bleeding by clamping blood vessels during surgery.",
  ...
  },
  {
    ...
    correctIndex: 2,
    explanation: "A needle holder is a locking forceps designed specifically to grip and drive suture needles through tissue.",
    category: "Surgical Instruments"
  },
  {
    id: 3,
    ...
    correctIndex: 3,
    explanation: "A scalpel consists of a handle and a disposable blade and is used to make precise incisions in skin and tissue.",
    category: "Surgical Instruments"
  },
  {
    id: 4,
    ...
    correctIndex: 1,
    explanation: "Lateral recumbency means the animal is lying on its side. It is commonly used for physical exams, radiographs, and minor procedures.",
  ...
  },
  {
    ...
    question: "When restraining a dog on an exam table, which is the most important safety concern?",
    options: [
    ...
    correctIndex: 1,
    explanation: "The primary safety concern is preventing the dog from jumping off the table, which could result in serious injury to the patient.",
    category: "Dog Restraint"
  },
  {
    id: 6,
    ...
    correctIndex: 1,
    explanation: 'The "kitty burrito" wraps the cat snugly in a towel to limit limb movement, reducing stress and risk of injury during exams and procedures.',
  ...
  },
  {
    ...
    correctIndex: 1,
    explanation: "Towel restraint reduces stress by limiting the cat's ability to scratch or bite while keeping them calm and contained without chemical restraint.",
    category: "Cat Restraint"
  },
  {
    id: 8,
    ...
    question: "Where is the best location to auscultate (listen to) the heart in a dog?",
    options: [
    ...
    correctIndex: 1,
    explanation: "The apex of the heart is best heard on the left side, caudal to the elbow at the 5th intercostal space in dogs.",
  ...
  },
  {
    ...
    correctIndex: 1,
    explanation: "The normal rectal temperature for dogs is 99-102.5°F (37.2-39.2°C). Temperatures above 103°F may indicate fever or hyperthermia.",
    category: "Dog Anatomy"
  },
  {
    id: 10,
    ...
    correctIndex: 3,
    explanation: "Cats have a resting heart rate of 160-240 bpm, significantly faster than humans or dogs due to their smaller body size.",
  ...
  },
  {
    ...
    correctIndex: 1,
    explanation: "Normal respiratory rate for cats at rest is 16-40 breaths per minute. Rates above 40 at rest may indicate respiratory distress.",
    category: "Cat Anatomy"
  }
];
...
function VisualLearningPage() {
  ...
  const [questions2, setQuestions] = reactExports.useState([]);
  const [idx, setIdx] = reactExports.useState(0);
  const [selected, setSelected] = reactExports.useState(null);
  const [score, setScore] = reactExports.useState(0);
  const [done, setDone] = reactExports.useState(false);
  const start = (cat) => {
    const qs = visualQuestions.filter((q2) => q2.category === cat);
    setQuestions(qs);
    setIdx(0);
    setSelected(null);
    setScore(0);
  ...
  const handleSelect = (i) => {
    ...
    setSelected(i);
    if (i === questions2[idx].correctIndex) setScore((s) => s + 1);
  };
  const handleNext = () => {
    if (idx + 1 >= questions2.length) {
      setDone(true);
    } else {
      setIdx((i) => i + 1);
      setSelected(null);
  ...
  if (!category) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl font-extrabold text-gray-800", children: "Visual Learning" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-gray-500", children: "Identify veterinary images and diagrams" }),
      VISUAL_CATEGORIES.map((cat) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          type: "button",
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 px-4 text-left", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-gray-700", children: cat.label }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-gray-400", children: [
                visualQuestions.filter((q2) => q2.category === cat.key).length,
                " ",
                "questions"
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronRight, { size: 16, className: "text-gray-300 mr-3" })
          ]
        },
        cat.key
      ))
  ...
  if (done) {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-6 py-8", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-7xl font-extrabold text-teal-600", children: [
        pct,
        "%"
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-gray-600", children: [
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 h-2 bg-gray-100 rounded-full", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          ...
          style: { width: `${idx / questions2.length * 100}%` }
        }
      ) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs text-gray-500", children: [
        idx + 1,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-gray-400 text-center", children: q.imageCaption }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-white rounded-2xl p-4 shadow-sm border border-gray-100", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-gray-800", children: q.question }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col gap-2", children: q.options.map((opt, i) => {
      let style2 = "bg-white border-gray-200 hover:border-orange-400";
      if (selected !== null) {
        if (i === q.correctIndex)
          style2 = "bg-green-50 border-green-500 text-green-800";
        else if (i === selected)
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          ...
          className: `w-full text-left p-4 rounded-2xl border-2 transition-all flex items-start gap-3 ${style2}`,
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "flex-shrink-0 w-6 h-6 rounded-full border-2 border-gray-300 flex items-center justify-center text-xs font-bold", children: letters[i] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-medium", children: opt })
          ]
        },
        i
    ...
    selected !== null && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        className: `rounded-2xl p-4 ${selected === q.correctIndex ? "bg-green-50 border border-green-200" : "bg-orange-50 border border-orange-200"}`,
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "p",
            {
              className: `text-sm font-semibold mb-1 ${selected === q.correctIndex ? "text-green-700" : "text-orange-700"}`,
              children: selected === q.correctIndex ? "✓ Correct!" : "✗ Incorrect"
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-gray-700", children: q.explanation })
        ]
      }
    ),
    selected !== null && /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        ...
        children: idx + 1 >= questions2.length ? "See Results" : "Next"
      }
    )
  ] });
}
...
function App() {
  ...
  const streakRaw = typeof window !== "undefined" ? localStorage.getItem("vet_streak") : null;
  const streak = streakRaw ? JSON.parse(streakRaw).count : 0;
  const dailyRaw = typeof window !== "undefined" ? localStorage.getItem("vet_daily_challenge") : null;
  const dailyCompleted = dailyRaw ? JSON.parse(dailyRaw).date === (/* @__PURE__ */ new Date()).toISOString().slice(0, 10) && JSON.parse(dailyRaw).completed : false;
  ...
  if (!isDatasetsReady()) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center justify-center min-h-screen gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-600 text-lg", children: "Loading study content..." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { onClick: () => setRetryCount((c) => c + 1), variant: "outline", children: "Retry" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden", children: retryCount })
    ] });
  }
  if (subPage === "daily") {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen bg-gray-50", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-[430px] mx-auto px-4 pt-6 pb-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx(DailyChallengePage, { questions, onBack: handleBack }) }) });
  }
  if (subPage === "quick") {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen bg-gray-50", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-[430px] mx-auto px-4 pt-6 pb-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx(QuickStudyPage, { questions, onBack: handleBack }) }) });
  }
  if (subPage === "prepVideo") {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen bg-gray-50", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-[430px] mx-auto px-4 pt-6 pb-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx(PrepVideoPage, { onBack: handleBack }) }) });
  }
  if (subPage === "visual") {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-gray-50", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-[430px] mx-auto px-4 pt-6 pb-24", children: /* @__PURE__ */ jsxRuntimeExports.jsx(VisualLearningPage, {}) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(BottomNav, { current: tab, onChange: handleTabChange })
    ] });
  }
  if (subPage === "scenarios") {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-gray-50", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-[430px] mx-auto px-4 pt-6 pb-24", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ScenariosPage, { scenarios, loading: false }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(BottomNav, { current: tab, onChange: handleTabChange })
    ] });
  }
  if (subPage === "bookmarks") {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen bg-gray-50", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-[430px] mx-auto px-4 pt-6 pb-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx(BookmarksPage, { questions, onBack: handleBack }) }) });
  }
  const renderContent = () => {
    switch (tab) {
      case "home":
      ...
      case "quiz":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(QuizPage, { questions, loading: false });
      case "flashcards":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(FlashcardsPage, { flashcards, loading: false });
      case "videos":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(VideosPage, { videoQuestions });
      case "progress":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(ProgressPage, {});
      default:
        return null;
    }
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-gray-50", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-[430px] mx-auto px-4 pt-6 pb-24", children: renderContent() }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(BottomNav, { current: tab, onChange: handleTabChange })
  ] });
}
...
const VideoLesson = Record({
  "id": Nat,
  "title": Text,
  "learningObjectives": Vec(Text),
  "summary": Text,
  "youtubeId": Text,
  "quizQuestions": Vec(Question)
});
const LessonWithQuestions = Record({
  "lesson": VideoLesson,
  "questions": Vec(Question)
});
Service({
  "countAllData": Func([], [Nat], ["query"]),
  "countFlashcardsByCategory": Func(
    [],
    [Vec(Tuple(Text, Nat))],
    ["query"]
  ),
  "countQuestionsByCategory": Func(
    [],
    [Vec(Tuple(Text, Nat))],
    ["query"]
  ),
  "explainAnswer": Func([Nat, Int], [Text], ["query"]),
  "explainScenario": Func([Nat, Int], [Text], ["query"]),
  "getAllFlashcards": Func([], [Vec(Flashcard)], ["query"]),
  "getAllQuestions": Func([], [Vec(Question)], ["query"]),
  "getAllScenarios": Func([], [Vec(Scenario)], ["query"]),
  "getAllVideoLessons": Func([], [Vec(VideoLesson)], ["query"]),
  "getFlashcardsByCategory": Func(
    [Text],
    [Vec(Flashcard)],
    ["query"]
  ),
  "getQuestionsByCategory": Func(
    [Text],
    [Vec(Question)],
    ["query"]
  ),
  "getVideoLessonsWithQuestions": Func(
    [],
    [Vec(LessonWithQuestions)],
    ["query"]
  ),
  "initializeData": Func([], [], [])
});
